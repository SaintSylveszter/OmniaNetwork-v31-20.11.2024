...
import ArticleDataTab from './ArticleDataTab';
import ProductsTab from './ProductsTab';
import ImagesTab from './ImagesTab';
import SeoSocialTab from './SeoSocialTab';
...
const OldArticleForm: React.FC<ArticleFormProps> = ({ onSubmit, onClose, initialData }) => {
